...
| G5 SURFACE accepted | `ACCEPTED_WAITING_ORDER` | SURFACE + reviewer | S01–S10 accepted at rebased lane `c68980b`; merge waits behind ENGINE |
...
| SURFACE | `feat/rni-surface-demo` | `READY_FOR_MERGE`; waits behind ENGINE | `SURFACE.md` | `c68980b` |
