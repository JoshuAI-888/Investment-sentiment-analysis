...
import { resolveCalculationIssueMutation } from '@/services/admin/calculation-issues';
...
export async function POST(request: Request) {
  ...
  const outcome = await runAdminMutation(resolveCalculationIssueMutation, body, session);
