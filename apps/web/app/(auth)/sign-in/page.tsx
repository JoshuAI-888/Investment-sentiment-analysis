 ...
 * every environment, including this one under e2e (`PROVIDER_MODE=fixture`, no live Resend
 * call, no live database — F02's storage swaps to an in-memory adapter in that mode).
 */
  ...
  return (
    <main data-route="/sign-in" data-state={env.PROVIDER_MODE} className="mx-auto max-w-sm p-8">
      ...
      <p className="mt-1 text-sm text-neutral-600">
        One account, one email, a six-digit code — no password.
      </p>
      <SignInForm />
    </main>
  );
