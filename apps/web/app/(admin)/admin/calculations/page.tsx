...
export default async function Page() {
  try {
    ...
    if (error instanceof UnauthorizedError) return <AdminDenied route="/admin/calculations" />;
    throw error;
  }

  return <RouteShell route="/admin/calculations" title="Calculations" owner="F15 (SURFACE)" />;
}
